...
ACLOCAL = ${SHELL} /home/wil/workspace/zebra-dev/missing --run aclocal-1.6
AUTOCONF = ${SHELL} /home/wil/workspace/zebra-dev/missing --run autoconf
AUTOMAKE = ${SHELL} /home/wil/workspace/zebra-dev/missing --run automake-1.6
AUTOHEADER = ${SHELL} /home/wil/workspace/zebra-dev/missing --run autoheader
...
OBJEXT = o
PATH_SEPARATOR = :
AMTAR = ${SHELL} /home/wil/workspace/zebra-dev/missing --run tar
AR = ar
AWK = gawk
BGPD = bgpd
CC = gcc
...
am__include = include
am__quote = 
install_sh = /home/wil/workspace/zebra-dev/install-sh

SUBDIRS = lib zebra bgpd ripd ripngd ospfd ospf6d  doc
